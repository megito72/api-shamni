...
$downline_member = count(getteam_member($uid));
$downline_members = getteam_member_arr($uid);
$hold_property = get_hold_property_count($downline_members, 1);
$booked_property = get_booked_property_count($downline_members, 2);
$rs[] = ["Total Members" => $downline_member, "Hold Property" => $hold_property, "Booked Property" => $booked_property];
if ($uid && $hold_property) {
